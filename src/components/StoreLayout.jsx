...
//     const sectionHeight = dimensions.height * BASE_CELL_SIZE;
...
//           const cellY = cell.posY * BASE_CELL_SIZE + 2;
...
//                 section={section}
//                 x={section.posX * BASE_CELL_SIZE + PADDING}
//                 y={section.posY * BASE_CELL_SIZE + PADDING + 40}
//               />
//             ))}
//           </Layer>
//         </Stage>
          ...
          <Layer>
            ...
            {layoutData.sections.map((section, index) => (
              <ShelfSection
                ...
                section={section}
                x={section.posX * BASE_CELL_SIZE + PADDING}
                y={section.posY * BASE_CELL_SIZE + PADDING}
              />
            ))}
          </Layer>
        </Stage>
